...
<div class="nep-view">
    ...
    <div class="row">
        <div class="col-md-4">
            ...
            <?= !empty($items) ? Collapse::widget(['items' => $items]) : '<p>No objects allocated with amount. Try putting instead. '.Html::a('Click Here', ['/v1/nep/form', 'id' => $model->id]).'</p>' ?>
        </div>
        <div class="col-md-6">
...
<?php
  $script = '
    ...
    {
        $.ajax({
            url: "'.Url::to(['/v1/nep/allocation-form']).'?id=" + id,
            beforeSend: function(){
