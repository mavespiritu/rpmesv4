...
<div class="pull-left">
    <?= ButtonDropdown::widget([
        ...
        'dropdown' => [
            'items' => [
                ['label' => 'Excel', 'url' => Url::to(['/v1/app/download', 'type' => 'excel', 'post' => json_encode($postData)])],
                ['label' => 'PDF', 'url' => Url::to(['/v1/app/download', 'type' => 'pdf', 'post' => json_encode($postData)])],
            ],
        ],
    ]); ?>
...
<div class="panel panel-default">
    ...
    <p class="header-title">Filename: <?= $filename ?></p>
    <p class="text-center">APP-CSE 2022 FORM<br>
    ...
    <br>
    <br>
    <p class="text-center"><i>Note: Consistent with <b>Memorandum Circular No. 2021-1 dated 03 June 2021, issued by AO 25,</b> the APP-CSE for FY 2022 must be submitted on or before <b>31 August 2021.</b></i></p>
    <div>
    <table style="width: 100%;">
        <tr>
            <td style="border: none; font-size: 14px;" align=right>Department/Bureau/Office:&nbsp;&nbsp;&nbsp;</td>
            <td style="border: none; font-size: 14px;" ><u><?= $entity->value ?></u></td>      
            <td style="border: none; font-size: 14px;" align=right>Agency Code/UACS:&nbsp;&nbsp;&nbsp;</td>
            <td style="border: none; font-size: 14px;" ><u><?= $agencyCode->value ?></u></td>
            <td style="border: none; font-size: 14px;" align=right>Contact Person:&nbsp;&nbsp;&nbsp;</td>
            <td style="border: none; font-size: 14px;" ><u><?= $contactPerson->value ?></u></td>
        </tr>
        <tr>
            <td style="border: none; font-size: 14px;" align=right>Region:&nbsp;&nbsp;&nbsp;</td>
            <td style="border: none; font-size: 14px;" ><u><?= $region->value ?></u></td>
            <td style="border: none; font-size: 14px;" align=right>Organization Type:&nbsp;&nbsp;&nbsp;</td>
            <td style="border: none; font-size: 14px;" ><u><?= $organizationType->value ?></u></td>
            <td style="border: none; font-size: 14px;" align=right>Position:&nbsp;&nbsp;&nbsp;</td>
            <td style="border: none; font-size: 14px;" ><u><?= $contactPersonPosition->value ?></u></td>
        </tr>
        <tr>
            <td style="border: none; font-size: 14px;" align=right>Address:&nbsp;&nbsp;&nbsp;</td>
            <td style="border: none; font-size: 14px;" ><u><?= $address->value ?></u></td>
            <td style="border: none; font-size: 14px;" align=right></td>
            <td style="border: none; font-size: 14px;" ></td>
            <td style="border: none; font-size: 14px;" align=right>E-mail:&nbsp;&nbsp;&nbsp;</td>
            <td style="border: none; font-size: 14px;" ><u><span style="color: blue;"><?= $email->value ?></span></u></td>
        </tr>
        <tr>
            <td style="border: none; font-size: 14px;" align=right></td>
            <td style="border: none; font-size: 14px;" ></td>
            <td style="border: none; font-size: 14px;" align=right></td>
            <td style="border: none; font-size: 14px;" ></td>
            <td style="border: none; font-size: 14px;" align=right>Telephone/Mobile No.:&nbsp;&nbsp;&nbsp;</td>
            <td style="border: none; font-size: 14px;" ><u><?= $telephone->value.'/'.$mobile->value ?></u></td>
        </tr>
    </table>
    </div>
    <br>
    ...
    <div class="row">
        <div class="col-md-4">
            <p><b>Prepared By:</b><br><br><br>
                <u><?= Yii::$app->user->identity->userinfo->fullName ?></u><br>
                <b><?= Yii::$app->user->identity->userinfo->POSITION_C ?></b>
            </p>
        </div>
        <div class="col-md-4">
            <p><b>Certified Funds Available / Certified Appropriate Funds Available:</b><br><br><br>
                <u><?= $accountant->value ?></u><br>
                <b><?= $accountantPosition->value ?></b>
            </p>
        </div>
        <div class="col-md-4">
            <p><b>Approved By:</b><br><br><br>
                <u><?= $regionalDirector->value ?></u><br>
                <b>Regional Director</b>
            </p>
        </div>
    </div>
    </div>
