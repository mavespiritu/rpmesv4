                ...
                $dueDate ? 
                    strtotime(date("Y-m-d")) <= strtotime($dueDate->due_date) ?
                        Html::a('<i class="fa fa-paper-plane-o"></i> Submit Form 4', ['submit', 'id' => $model->id], [
                            ...
                            'data' => [
                                'confirm' => 'The data I encoded had been duly approved by my Agency Head. I am providing my name and designation in the appropriate fields as an attestation of my submission\'s data integrity. Are you sure you want to submit this Form 4?',
                                'method' => 'post',
                            ],
                        ]) :
                    '' :
