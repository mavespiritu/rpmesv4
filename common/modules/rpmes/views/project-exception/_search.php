...
<div class="pull-left">
    <?= Html::button('<i class="fa fa-plus"></i> Add Project Exception Report', ['value' => Url::to(['create']), 'class' => 'btn btn-success', 'id' => 'create-button']) ?>
</div>
...
<?php
  Modal::begin([
    'id' => 'create-modal',
    'size' => "modal-md",
    'header' => '<div id="create-modal-header"><h4>Add Project Exception Report</h4></div>',
...
<?php
  Modal::begin([
    'id' => 'follow-up-modal',
    'size' => "modal-md",
    'header' => '<div id="follow-up-modal-header"><h4>Follow-up Form 3 Submission</h4></div>',
    'options' => ['tabindex' => false],
  ]);
  echo '<div id="follow-up-modal-content"></div>';
  Modal::end();
?>
<?php
    $script = '
        $(document).ready(function(){
            ...
            $("#follow-up-button").click(function(){
                $("#follow-up-modal").modal("show").find("#follow-up-modal-content").load($(this).attr("value"));
              });
        });     
    ';
