...
$this->title = 'RPMES Form 3: Project Exception Report';
...
<?php foreach ($dataProvider->models as $model): ?>
    ...
    Modal::begin([
        ...
        'size' => "modal-md",
        'header' => '<div id="update-modal-'.$modelID.'-header"><h4>Update Project Exception Report</h4></div>',
...
<div class="project-exception-index">
    ...
    <div class="box box-solid">
        <div class="box-header with-border">
            <h3 class="box-title">Project Exception Reports</h3>
        </div>
        <div class="box-body">
