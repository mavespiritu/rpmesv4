...
<div class="pull-left">
    ...
    <?= Yii::$app->user->can('Administrator') ? Html::button('<i class="fa fa-print"></i> Generate Form 11', ['value' => Url::to(['/rpmes/project-problem/generate']), 'class' => 'btn btn-default', 'id' => 'generate-button']) : '' ?>
</div>
...
<?php
  Modal::begin([
    'id' => 'generate-modal',
    'size' => "modal-sm",
    'header' => '<div id="generate-modal-header"><h4>Generate Form 11</h4></div>',
