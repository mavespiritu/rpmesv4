...
<?php
    $script = '
    $("#agreement-form").on("beforeSubmit", function (e) {
        e.preventDefault();
        ...
        $.ajax({
            ...
            data: formData,
            beforeSend: function(){
                $("#agreement-table").html("<div class=\"text-center\"><svg class=\"spinner\" width=\"30px\" height=\"30px\" viewBox=\"0 0 66 66\" xmlns=\"http://www.w3.org/2000/svg\"><circle class=\"path\" fill=\"none\" stroke-width=\"6\" stroke-linecap=\"round\" cx=\"33\" cy=\"33\" r=\"30\"></circle></svg></div>");
            },
            success: function (data) {
                console.log(this.data);
                $("#agreement-table").empty();
                $("#agreement-table").hide();
                $("#agreement-table").fadeIn("slow");
                $("#agreement-table").html(data);
            },
            error: function (err) {
                console.log(err);
            }
