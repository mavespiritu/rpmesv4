...
<table class="table table-bordered table-condensed table-responsive">
    <tbody>
        ...
        <tr><td colspan=2><b>Subject: Submission of CY <?= $submission->year ?> Regional Project Monitoring and Evaluation System (RPMES) Form 1 (Project Monitoring Plan)</b></td></tr>
        <tr>
            <td colspan=2>
                <b>Findings:</b>
...
<div class="pull-right">
    <?= Html::submitButton('Save Acknowledgment', ['class' => 'btn btn-success', 'data' => ['disabled-text' => 'Please Wait']]) ?>
</div>
