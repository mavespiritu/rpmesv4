...
<table class="table table-bordered table-condensed table-responsive">
    <tbody>
        ...
        <tr><td colspan=2><b>Subject: Submission of CY <?= $submission->year ?> <?= $submission->quarter ?> Regional Project Monitoring and Evaluation System (RPMES) Form 2 (Physical and Financial Accomplishment Report)</b></td></tr>
        <tr>
            <td colspan=2>
                <b>Findings:</b>
