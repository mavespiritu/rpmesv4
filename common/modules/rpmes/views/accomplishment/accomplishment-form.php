                ...
                <table id="accomplishment-table" class="table table-bordered table-responsive table-striped table-hover" cellspacing="0" style="min-width: 3000px;">
                    ...
                    <?php if(!empty($projectsModels)){ ?>
                        ...
                        <?php foreach($projectsModels as $plan){ ?>
                            ...
                            <tr>
                                <td><?= $i ?></td>
                                <td><?= $project->project_no.': '.$project->title ?></td>
                                <td align=right><?= number_format($plan->project->getFinancialTargetPerQuarter($model->year)[$model->quarter], 2) ?></td>
                                <td><?= $form->field($accomplishments[$project->id]['financial'], "[$project->id][financial]allocation")->widget(MaskedInput::classname(), [
                                    'options' => [
                                        'autocomplete' => 'off',
                                ...
                                <td><?= $form->field($accomplishments[$project->id]['financial'], "[$project->id][financial]releases")->widget(MaskedInput::classname(), [
                                    'options' => [
                                        'autocomplete' => 'off',
                                ...
                                <td><?= $form->field($accomplishments[$project->id]['financial'], "[$project->id][financial]obligation")->widget(MaskedInput::classname(), [
                                    'options' => [
                                        'autocomplete' => 'off',
                                ...
                                <td><?= $form->field($accomplishments[$project->id]['financial'], "[$project->id][financial]expenditures")->widget(MaskedInput::classname(), [
                                    'options' => [
                                        'autocomplete' => 'off',
                                ...
                                <td align=center><?= number_format($project->getNewMalesEmployedTarget($model->year), 0) ?></td>
                                <td><?= $form->field($accomplishments[$project->id]['personEmployed'], "[$project->id][personEmployed]male")->widget(MaskedInput::classname(), [
                                    'options' => [
                                        'autocomplete' => 'off',
                                ...
                                <td><?= $form->field($accomplishments[$project->id]['personEmployed'], "[$project->id][personEmployed]female")->widget(MaskedInput::classname(), [
                                    'options' => [
                                        'autocomplete' => 'off',
                               ...
                               <td><?= $form->field($accomplishments[$project->id]['accomplishment'], "[$project->id][accomplishment]remarks")->textInput(['onKeyup' => 'updateAccomplishmentTable()'])->label(false) ?></td>
                            </tr>
                            <?php $i++ ?>
                        <?php } ?>
                    <?php } ?>
