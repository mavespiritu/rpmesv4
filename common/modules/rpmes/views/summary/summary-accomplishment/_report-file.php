...
<table class="table table-condensed table-bordered table-striped table-hover table-condensed table-responsive" cellspacing="0" style="min-width: 3000px;">
    ...
    <?php if(!empty($data)){ ?>
        ...
        <?php foreach($data as $firstLevel => $firstLevels){ ?>
                ...
                <td align=right><?= number_format($physical['actual'][$firstLevel]['value'] - $physical['target'][$firstLevel]['value'], 2) ?></td>
            ...
            <?php if(!empty($firstLevels['firstLevels'])){ ?>
                ...
                <?php foreach($firstLevels['firstLevels'] as $secondLevel => $secondLevels){ ?>
                    <tr style="font-weight: bolder;">
                        ...
                        <td align=right><?= number_format($physical['actual'][$firstLevel]['firstLevels'][$secondLevel]['value'] - $physical['target'][$firstLevel]['firstLevels'][$secondLevel]['value'], 2) ?></td>
                    ...
                    <?php if(!empty($secondLevels['secondLevels'])){ ?>
                        ...
                        <?php foreach($secondLevels['secondLevels'] as $thirdLevel => $thirdLevels){ ?>
                            ...
                            <?php } ?>
                                ...
                                <?php } ?>
                                <?php if(!empty($thirdLevels['thirdLevels'])){ ?>
                                    <td align=right><?= number_format($physical['actual'][$firstLevel]['firstLevels'][$secondLevel]['secondLevels'][$thirdLevel]['value'] - $physical['target'][$firstLevel]['firstLevels'][$secondLevel]['secondLevels'][$thirdLevel]['value'], 2)?></td>
                            ...
                            <?php if(!empty($thirdLevels['thirdLevels'])){ ?>
                                ...
                                <?php foreach($thirdLevels['thirdLevels'] as $fourthLevel => $fourthLevels){ ?>
                                    ...
                                    <?php } ?>
                                        ...
                                        <?php } ?>
                                        <?php if(!empty($fourthLevels['fourthLevels'])){ ?>
                                            <td align=right><?= number_format($physical['actual'][$firstLevel]['firstLevels'][$secondLevel]['secondLevels'][$thirdLevel]['thirdLevels'][$fourthLevel]['value'] - $physical['target'][$firstLevel]['firstLevels'][$secondLevel]['secondLevels'][$thirdLevel]['thirdLevels'][$fourthLevel]['value'], 2).')' ?></td>
                                    ...
                                    <?php if(!empty($fourthLevels['fourthLevels'])){ ?>
                                        ...
                                        <?php foreach($fourthLevels['fourthLevels'] as $fifthlevel => $fifthlevels){ ?>
                                            ...
                                            <?php } ?>
                                                ...
                                                <?php } ?>
                                                <?php if(!empty($fifthlevels['fifthlevels'])){ ?>
                                                    <td align=right><?= number_format($physical['actual'][$firstLevel]['firstLevels'][$secondLevel]['secondLevels'][$thirdLevel]['thirdLevels'][$fourthLevel]['fourthLevels'][$fifthlevel]['value'] - $physical['target'][$firstLevel]['firstLevels'][$secondLevel]['secondLevels'][$thirdLevel]['thirdLevels'][$fourthLevel]['fourthLevels'][$fifthlevel]['value'], 2).')' ?></td>
    ...
    <tr style="font-weight: bolder;">
        ...
        <td align=right>-</td>
        <td align=right>-</td>
        <td align=right><?= number_format($totalPhysical['actual'] - $totalPhysical['target'], 2).')' ?></td>
        <td align=right><?= $totalPhysical['target'] > 0 ? number_format(($totalPhysical['actual'] / $totalPhysical['target']) * 100, 2) : number_format(0, 2) ?></td>
        <td align=right><?= number_format($total['malesEmployedTarget'], 0) ?></td>
        <td align=right><?= number_format($total['femalesEmployedTarget'], 0) ?></td>
        <td align=right><?= number_format($total['malesEmployedTarget'] + $total['femalesEmployedTarget'], 0) ?></td>
