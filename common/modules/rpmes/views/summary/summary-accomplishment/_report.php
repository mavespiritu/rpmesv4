    ...
    <table class="table table-condensed table-bordered table-striped table-hover table-condensed table-responsive" cellspacing="0" style="min-width: 3000px;">
        ...
        <?php if(!empty($data)){ ?>
            ...
            <?php foreach($data as $firstLevel => $firstLevels){ ?>
                    ...
                    <td align=right><?= number_format(floatval($physical['actual'][$firstLevel]['value']) - floatval($physical['target'][$firstLevel]['value']), 2) ?></td>
                ...
                <?php if(!empty($firstLevels['firstLevels'])){ ?>
                    ...
                    <?php foreach($firstLevels['firstLevels'] as $secondLevel => $secondLevels){ ?>
                        <tr style="font-weight: bolder;">
                            ...
                            <td align=right><?= number_format(floatval($physical['actual'][$firstLevel]['firstLevels'][$secondLevel]['value']) - floatval($physical['target'][$firstLevel]['firstLevels'][$secondLevel]['value']), 2) ?></td>
                        ...
                        <?php if(!empty($secondLevels['secondLevels'])){ ?>
                            ...
                            <?php foreach($secondLevels['secondLevels'] as $thirdLevel => $thirdLevels){ ?>
                                ...
                                <?php } ?>
                                    ...
                                    <?php } ?>
                                    <?php if(!empty($thirdLevels['thirdLevels'])){ ?>
                                        <td align=right><?= number_format(floatval($physical['actual'][$firstLevel]['firstLevels'][$secondLevel]['secondLevels'][$thirdLevel]['value']) - floatval($physical['target'][$firstLevel]['firstLevels'][$secondLevel]['secondLevels'][$thirdLevel]['value']), 2)?></td>
                                ...
                                <?php if(!empty($thirdLevels['thirdLevels'])){ ?>
                                    ...
                                    <?php foreach($thirdLevels['thirdLevels'] as $fourthLevel => $fourthLevels){ ?>
                                        ...
                                        <?php } ?>
                                            ...
                                            <?php } ?>
                                            <?php if(!empty($fourthLevels['fourthLevels'])){ ?>
                                                <td align=right><?= number_format(floatval($physical['actual'][$firstLevel]['firstLevels'][$secondLevel]['secondLevels'][$thirdLevel]['thirdLevels'][$fourthLevel]['value']) - floatval($physical['target'][$firstLevel]['firstLevels'][$secondLevel]['secondLevels'][$thirdLevel]['thirdLevels'][$fourthLevel]['value']), 2).')' ?></td>
