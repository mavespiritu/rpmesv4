...
<div class="summary-summary-accomplishment-table" style="height: 600px;">
    ...
    <table class="table table-condensed table-bordered table-striped table-hover table-condensed table-responsive" cellspacing="0" style="min-width: 3000px;">
        ...
        <td colspan=7>Grand Total</td>
            ...
            <td align=right>-</td>
            <td align=right>-</td>
            <td align=right><?= floatval($totalPhysical['actual']) - floatval($totalPhysical['target']) >= 0 ? number_format(floatval($totalPhysical['actual']) - floatval($totalPhysical['target']), 2) : '('.number_format(abs($totalPhysical['actual'] - $totalPhysical['target']), 2).')' ?></td>
            <td align=right><?= floatval($totalPhysical['target']) > 0 ? number_format((floatval($totalPhysical['actual']) / floatval($totalPhysical['target'])) * 100, 2) : number_format(0, 2) ?></td>
        ...
        <?php if(!empty($data)){ ?>
            ...
            <?php foreach($data as $firstLevel => $firstLevels){ ?>
                    ...
                    <td align=right><?= floatval($firstLevels['content']['allocations']) > 0 ? number_format((floatval($firstLevels['content']['releases']) / floatval($firstLevels['content']['allocations'])) * 100, 2) : number_format(0, 2) ?></td>
                    <td align=right><?= floatval($firstLevels['content']['releases']) > 0 ? number_format((floatval($firstLevels['content']['expenditures']) / floatval($firstLevels['content']['releases'])) * 100, 2) : number_format(0, 2) ?></td>
                    ...
                    <td align=right><?= floatval($physical['actual'][$firstLevel]['value']) - floatval($physical['target'][$firstLevel]['value']) >= 0 ? number_format(floatval($physical['actual'][$firstLevel]['value']) - floatval($physical['target'][$firstLevel]['value']), 2) : number_format(abs($physical['actual'][$firstLevel]['value'] - $physical['target'][$firstLevel]['value']), 2) ?></td>
                    <td align=right><?= $physical['target'][$firstLevel]['value'] > 0 ? number_format((floatval($physical['actual'][$firstLevel]['value']) / floatval($physical['target'][$firstLevel]['value'])) * 100, 2) : number_format(0, 2) ?></td>
                ...
                <?php if(!empty($firstLevels['firstLevels'])){ ?>
                    ...
                    <?php foreach($firstLevels['firstLevels'] as $secondLevel => $secondLevels){ ?>
                        <tr style="font-weight: bolder;">
                            ...
                            <td align=right><?= floatval($physical['actual'][$firstLevel]['firstLevels'][$secondLevel]['value']) - floatval($physical['target'][$firstLevel]['firstLevels'][$secondLevel]['value']) >= 0 ? number_format(floatval($physical['actual'][$firstLevel]['firstLevels'][$secondLevel]['value']) - floatval($physical['target'][$firstLevel]['firstLevels'][$secondLevel]['value']), 2) : number_format(abs(floatval($physical['actual'][$firstLevel]['firstLevels'][$secondLevel]['value']) - floatval($physical['target'][$firstLevel]['firstLevels'][$secondLevel]['value'])), 2) ?></td>
                            <td align=right><?= floatval($physical['target'][$firstLevel]['firstLevels'][$secondLevel]['value']) > 0 ? number_format((floatval($physical['actual'][$firstLevel]['firstLevels'][$secondLevel]['value']) / floatval($physical['target'][$firstLevel]['firstLevels'][$secondLevel]['value'])) * 100, 2) : number_format(0, 2) ?></td>
                        ...
                        <?php if(!empty($secondLevels['secondLevels'])){ ?>
                            ...
                            <?php foreach($secondLevels['secondLevels'] as $thirdLevel => $thirdLevels){ ?>
                                ...
                                <?php } ?>
                                    ...
                                    <td align=right><?= floatval($thirdLevels['content']['allocations']) > 0 ? number_format((floatval($thirdLevels['content']['releases']) / floatval($thirdLevels['content']['allocations'])) * 100, 2) : number_format(0, 2) ?></td>
                                    <td align=right><?= $thirdLevels['content']['releases'] > 0 ? number_format((floatval($thirdLevels['content']['expenditures']) / floatval($thirdLevels['content']['releases'])) * 100, 2) : number_format(0, 2) ?></td>
                                    <?php if(!empty($thirdLevels['thirdLevels'])){ ?>
                                            <?= '<td align=right>'. number_format(floatval($physical['target'][$firstLevel]['firstLevels'][$secondLevel]['secondLevels'][$thirdLevel]['value']), 2).'</td>' ?>
                                            <?= '<td align=right>'. number_format(floatval($physical['actual'][$firstLevel]['firstLevels'][$secondLevel]['secondLevels'][$thirdLevel]['value']), 2).'</td>' ?>
                                            <?php }else{ ?>
                                            ...
                                            <?php } ?>
                                            <?php if(!empty($thirdLevels['thirdLevels'])){ ?>
                                            <td align=right><?= floatval($physical['actual'][$firstLevel]['firstLevels'][$secondLevel]['secondLevels'][$thirdLevel]['value']) - floatval($physical['target'][$firstLevel]['firstLevels'][$secondLevel]['secondLevels'][$thirdLevel]['value']) >= 0 ? number_format(floatval($physical['actual'][$firstLevel]['firstLevels'][$secondLevel]['secondLevels'][$thirdLevel]['value']) - floatval($physical['target'][$firstLevel]['firstLevels'][$secondLevel]['secondLevels'][$thirdLevel]['value']), 2) : number_format(abs(floatval($physical['actual'][$firstLevel]['firstLevels'][$secondLevel]['secondLevels'][$thirdLevel]['value']) - floatval($physical['target'][$firstLevel]['firstLevels'][$secondLevel]['secondLevels'][$thirdLevel]['value'])), 2)?></td>
                                            <td align=right><?= floatval($physical['target'][$firstLevel]['firstLevels'][$secondLevel]['secondLevels'][$thirdLevel]['value']) > 0 ? number_format((floatval($physical['actual'][$firstLevel]['firstLevels'][$secondLevel]['secondLevels'][$thirdLevel]['value']) / floatval($physical['target'][$firstLevel]['firstLevels'][$secondLevel]['secondLevels'][$thirdLevel]['value'])) * 100, 2) : number_format(0, 2) ?></td>
                                            <?php }else{ ?>
                                            <td align=right><?= number_format((floatval($thirdLevels['content']['projectPhysicalAccomp']) - floatval($thirdLevels['content']['projectPhysicalTarget'])), 2)?></td>
                                            <td align=right><?= floatval($thirdLevels['content']['projectPhysicalTarget']) > 0 ? number_format((floatval($thirdLevels['content']['projectPhysicalAccomp']) / floatval($thirdLevels['content']['projectPhysicalTarget'])) * 100, 2) : number_format(0, 2) ?></td>
                                    <?php } ?>
                                ...
                                <?php if(!empty($thirdLevels['thirdLevels'])){ ?>
                                    ...
                                    <?php foreach($thirdLevels['thirdLevels'] as $fourthLevel => $fourthLevels){ ?>
                                        ...
                                        <?php } ?>
                                            ...
                                            <td align=right><?= floatval($fourthLevels['content']['allocations']) > 0 ? number_format((floatval($fourthLevels['content']['releases']) / floatval($fourthLevels['content']['allocations'])) * 100, 2) : number_format(0, 2) ?></td>
                                            <td align=right><?= floatval($fourthLevels['content']['releases']) > 0 ? number_format((floatval($fourthLevels['content']['expenditures']) / floatval($fourthLevels['content']['releases'])) * 100, 2) : number_format(0, 2) ?></td>
                                            <?php if(!empty($fourthLevels['fourthLevels'])){ ?>
                                            <?= '<td align=right>'. number_format(floatval($physical['target'][$firstLevel]['firstLevels'][$secondLevel]['secondLevels'][$thirdLevel]['thirdLevels'][$fourthLevel]['value']), 2).'</td>' ?>
                                            <?= '<td align=right>'. number_format(floatval($physical['actual'][$firstLevel]['firstLevels'][$secondLevel]['secondLevels'][$thirdLevel]['thirdLevels'][$fourthLevel]['value']), 2).'</td>' ?>
                                            <?php }else{ ?>
                                            ...
                                            <?php } ?>
                                            <?php if(!empty($fourthLevels['fourthLevels'])){ ?>
                                            <td align=right><?= floatval($physical['actual'][$firstLevel]['firstLevels'][$secondLevel]['secondLevels'][$thirdLevel]['thirdLevels'][$fourthLevel]['value']) - floatval($physical['target'][$firstLevel]['firstLevels'][$secondLevel]['secondLevels'][$thirdLevel]['thirdLevels'][$fourthLevel]['value']) >= 0 ? number_format(floatval($physical['actual'][$firstLevel]['firstLevels'][$secondLevel]['secondLevels'][$thirdLevel]['thirdLevels'][$fourthLevel]['value']) - floatval($physical['target'][$firstLevel]['firstLevels'][$secondLevel]['secondLevels'][$thirdLevel]['thirdLevels'][$fourthLevel]['value']), 2) : '('.number_format(abs(floatval($physical['actual'][$firstLevel]['firstLevels'][$secondLevel]['secondLevels'][$thirdLevel]['thirdLevels'][$fourthLevel]['value']) - floatval($physical['target'][$firstLevel]['firstLevels'][$secondLevel]['secondLevels'][$thirdLevel]['thirdLevels'][$fourthLevel]['value'])), 2).')' ?></td>
                                            <td align=right><?= floatval($physical['target'][$firstLevel]['firstLevels'][$secondLevel]['secondLevels'][$thirdLevel]['thirdLevels'][$fourthLevel]['value']) > 0 ? number_format((floatval($physical['actual'][$firstLevel]['firstLevels'][$secondLevel]['secondLevels'][$thirdLevel]['thirdLevels'][$fourthLevel]['value']) / floatval($physical['target'][$firstLevel]['firstLevels'][$secondLevel]['secondLevels'][$thirdLevel]['thirdLevels'][$fourthLevel]['value'])) * 100, 2) : number_format(0, 2) ?></td>
                                            <?php }else{ ?>
                                            <td align=right><?= number_format((floatval($fourthLevels['content']['projectPhysicalAccomp']) - floatval($fourthLevels['content']['projectPhysicalTarget'])), 2)?></td>
                                            <td align=right><?= floatval($fourthLevels['content']['projectPhysicalTarget']) > 0 ? number_format((floatval($fourthLevels['content']['projectPhysicalAccomp']) / floatval($fourthLevels['content']['projectPhysicalTarget'])) * 100, 2) : number_format(0, 2) ?></td>
                                            <?php } ?>
                                        ...
                                        <?php if(!empty($fourthLevels['fourthLevels'])){ ?>
                                            ...
                                            <?php foreach($fourthLevels['fourthLevels'] as $fifthlevel => $fifthlevels){ ?>
                                                ...
                                                <?php } ?>
                                                    ...
                                                    <td align=right><?= $fifthlevels['content']['allocations'] > 0 ? number_format((floatval($fifthlevels['content']['releases']) / floatval($fifthlevels['content']['allocations'])) * 100, 2) : number_format(0, 2) ?></td>
                                                    <td align=right><?= $fifthlevels['content']['releases'] > 0 ? number_format(($floatval(fifthlevels['content']['expenditures']) / floatval($fifthlevels['content']['releases'])) * 100, 2) : number_format(0, 2) ?></td>
                                                    <?php if(!empty($fifthlevels['fifthlevels'])){ ?>
                                                    <?= '<td align=right>'. number_format(floatval($physical['target'][$firstLevel]['firstLevels'][$secondLevel]['secondLevels'][$thirdLevel]['thirdLevels'][$fourthLevel]['fourthLevels'][$fifthlevel]['value']), 2).'</td>' ?>
                                                    <?= '<td align=right>'. number_format(floatval($physical['actual'][$firstLevel]['firstLevels'][$secondLevel]['secondLevels'][$thirdLevel]['thirdLevels'][$fourthLevel]['fourthLevels'][$fifthlevel]['value']), 2).'</td>' ?>
                                                    <?php }else{ ?>
                                                    ...
                                                    <?php } ?>
                                                    <?php if(!empty($fifthlevels['fifthlevels'])){ ?>
                                                    <td align=right><?= floatval($physical['actual'][$firstLevel]['firstLevels'][$secondLevel]['secondLevels'][$thirdLevel]['thirdLevels'][$fourthLevel]['fourthLevels'][$fifthlevel]['value']) - floatval($physical['target'][$firstLevel]['firstLevels'][$secondLevel]['secondLevels'][$thirdLevel]['thirdLevels'][$fourthLevel]['fourthLevels'][$fifthlevel]['value']) >= 0 ? number_format(floatval($physical['actual'][$firstLevel]['firstLevels'][$secondLevel]['secondLevels'][$thirdLevel]['thirdLevels'][$fourthLevel]['fourthLevels'][$fifthlevel]['value']) - floatval($physical['target'][$firstLevel]['firstLevels'][$secondLevel]['secondLevels'][$thirdLevel]['thirdLevels'][$fourthLevel]['fourthLevels'][$fifthlevel]['value']), 2) : '('.number_format(abs(floatval($physical['actual'][$firstLevel]['firstLevels'][$secondLevel]['secondLevels'][$thirdLevel]['thirdLevels'][$fourthLevel]['fourthLevels'][$fifthlevel]['value']) - floatval($physical['target'][$firstLevel]['firstLevels'][$secondLevel]['secondLevels'][$thirdLevel]['thirdLevels'][$fourthLevel]['fourthLevels'][$fifthlevel]['value'])), 2).')' ?></td>
                                                    <td align=right><?= floatval($physical['target'][$firstLevel]['firstLevels'][$secondLevel]['secondLevels'][$thirdLevel]['thirdLevels'][$fourthLevel]['fourthLevels'][$fifthlevel]['value']) > 0 ? number_format((floatval($physical['actual'][$firstLevel]['firstLevels'][$secondLevel]['secondLevels'][$thirdLevel]['thirdLevels'][$fourthLevel]['fourthLevels'][$fifthlevel]['value']) / floatval($physical['target'][$firstLevel]['firstLevels'][$secondLevel]['secondLevels'][$thirdLevel]['thirdLevels'][$fourthLevel]['fourthLevels'][$fifthlevel]['value'])) * 100, 2) : number_format(0, 2) ?></td>
                                                    <?php }else{ ?>
                                                    <td align=right><?= number_format((floatval($fifthlevels['content']['projectPhysicalAccomp']) - floatval($fifthlevels['content']['projectPhysicalTarget'])), 2)?></td>
                                                    <td align=right><?= floatval($fifthlevels['content']['projectPhysicalTarget']) > 0 ? number_format((floatval($fifthlevels['content']['projectPhysicalAccomp']) / floatval($fifthlevels['content']['projectPhysicalTarget'])) * 100, 2) : number_format(0, 2) ?></td>
                                                    <?php } ?>
