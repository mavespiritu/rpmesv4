...
<div class="summary-monitoring-report-table" style="height: 600px;">
    <table class="table table-condensed table-bordered table-striped table-hover table-condensed table-responsive" cellspacing="0" style="min-width: 3000px;">
        ...
        <tr style="font-weight: bolder;">
            ...
            <td align=right><?= number_format($total['physicalTarget'], 0) ?></td>
            <td align=right><?= number_format($total['physicalActual'], 0) ?></td>
        ...
        <?php if(!empty($data)){ ?>
            ...
            <?php foreach($data as $firstLevel => $firstLevels){ ?>
                    <tr style="font-weight: bolder;">
                        ...
                        <td align=right><?= number_format($firstLevels['content']['physicalTarget'], 0) ?></td>
                        <td align=right><?= number_format($firstLevels['content']['physicalActual'], 0) ?></td>
                ...
                <?php if(!empty($firstLevels['firstLevels'])){ ?>
                    ...
                    <?php foreach($firstLevels['firstLevels'] as $secondLevel => $secondLevels){ ?>
                        <tr>
                            ...
                            <td align=right><?= number_format($secondLevels['content']['physicalTarget'], 0) ?></td>
                            <td align=right><?= number_format($secondLevels['content']['physicalActual'], 0) ?></td>
                        ...
                        <?php if(!empty($secondLevels['secondLevels'])){ ?>
                            ...
                            <?php foreach($secondLevels['secondLevels'] as $thirdLevel => $thirdLevels){ ?>
                                <tr>
                                    ...
                                    <td align=right><?= number_format($thirdLevels['content']['physicalTarget'], 0) ?></td>
                                    <td align=right><?= number_format($thirdLevels['content']['physicalActual'], 0) ?></td>
                                ...
                                <?php if(!empty($thirdLevels['thirdLevels'])){ ?>
                                    ...
                                    <?php foreach($thirdLevels['thirdLevels'] as $fourthLevel => $fourthLevels){ ?>
                                        <tr>
                                            ...
                                            <td align=right><?= number_format($fourthLevels['content']['physicalTarget'], 0) ?></td>
                                            <td align=right><?= number_format($fourthLevels['content']['physicalActual'], 0) ?></td>
