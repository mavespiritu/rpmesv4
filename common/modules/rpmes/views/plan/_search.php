...
<div class="pull-left">
    <?= Html::button('<i class="fa fa-plus"></i> Add Monitoring Plan', ['value' => Url::to(['create']), 'class' => 'btn btn-success', 'id' => 'create-button']) ?>
</div>
...
<?php
  Modal::begin([
    'id' => 'create-modal',
    'size' => "modal-md",
    'header' => '<div id="create-modal-header"><h4>Add Monitoring Plan</h4></div>',
