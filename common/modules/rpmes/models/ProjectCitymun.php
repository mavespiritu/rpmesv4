...
/**
 * This is the model class for table "project_citymun".
 *
 ...
 */
class ProjectCitymun extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return $this->region_id.'-'.$this->province_id.'-'.$this->citymun_id;
    }
