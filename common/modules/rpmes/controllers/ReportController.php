...
class ReportController extends \yii\web\Controller
{
    ...
    public function actionFormOne()
    {
        ...
        $model->scenario = 'generateFormOne';
        $model->year = date("Y");
    ...
    public function actionDownloadFormOne($type, $year, $agency_id, $model)
    {
        ...
        $filename = 'RPMES Form 1: INITIAL PROJECT REPORT (Physical and Financial Targets for Ongoing Programs and Projects)';

        if($type == 'excel')
        {
            header("Content-type: application/vnd.ms-excel");
            header("Content-Disposition: attachment; filename=".$filename.".xls");
            return $this->renderPartial('reports/form-one', [
                'model' => $model,
                'type' => $type,
                'projects' => $projects,
                'quarters' => $quarters,
        ...
        {
            $content = $this->renderPartial('reports/form-one', [
                'model' => $model,
                'type' => $type,
                'projects' => $projects,
                'quarters' => $quarters,
