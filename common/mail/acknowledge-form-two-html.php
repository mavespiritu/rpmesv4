...
<p>Please be informed that your submission of eRPMES Form 2: Physical and Financial Accomplishment Report for <?= $model->submission->quarter ?> <?= $model->submission->year ?> has been acknowledged last <?= date("F j, Y") ?> by <?= $model->acknowledger ?>, <?= $model->acknowledgerPosition ?> of the NEDA Regional Office 1. Please see details below for your reference: </p>
