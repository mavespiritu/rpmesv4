                ...
                'items' => [
                    ...
                    [
                        ...
                        'items' => [
                            ...
                            ['label' => 'RPMES Form 6', 'icon' => 'folder', 'url' => ['/rpmes/project-status'], 'visible' => !Yii::$app->user->isGuest && (in_array('SuperAdministrator', $userRoles) || in_array('Administrator', $userRoles))],
                            ...
                            ['label' => 'RPMES Form 11', 'icon' => 'folder', 'url' => ['/rpmes/project-problem'], 'visible' => !Yii::$app->user->isGuest && (in_array('SuperAdministrator', $userRoles) || in_array('Administrator', $userRoles))],
                        ],
